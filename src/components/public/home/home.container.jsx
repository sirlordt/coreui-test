...
const PublicHeader = React.lazy( () => import( '../header' ) );

class PublicHomeContainer extends Component {
  ...
  minimizeSidebar() {
    ...
    */
    ...
    this.setState( ( prevState ) => ( { isSidebarMinimized: !prevState.isSidebarMinimized } ) );
  ...
  closeSidebar() {
    ...
    */
    ...
    this.setState( () => ( { isSidebarOpen: 'responsive' } ) );
